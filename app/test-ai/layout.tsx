...
export default async function TestAILayout({ children }: { children: React.ReactNode }) {
  ...
  if (!modules.includes('ai_voice')) return <AppShell><ModuleDisabled name="Test AI" /></AppShell>

  return <AppShell mainClassName="flex flex-col h-screen">{children}</AppShell>
}
